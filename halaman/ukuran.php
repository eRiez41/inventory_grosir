...
// Ambil data ukuran dari tabel ukuran
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 offset-md-3 mt-4">
                <h1>Daftar Ukuran</h1>
                <a href="tambah_ukuran.php" class="btn btn-primary btn-tambah">
                ...
                <table class="table table-striped table-bordered mt-2">
                    ...
                    <tbody>
                        ...
                        while ($row = $resultUkuran->fetch_assoc()) {
                            ...
                            echo "<td>";
                            echo "<a href='edit_ukuran.php?id=" . $row['id'] . "' class='btn btn-sm btn-warning'>
                                    <i class='fas fa-edit'></i> Edit
                                  </a> ";
                            echo "<button class='btn btn-sm btn-danger' onclick='hapusUkuran(" . $row['id'] . ")'>
    ...
    <script>
        function hapusUkuran(id) {
            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: "Anda akan menghapus ukuran ini!",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    window.location.href = '../fungsi/fungsi_hapus_ukuran.php?id=' + id;
                }
            });
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            <?php if (isset($_SESSION['hapus_sukses'])): ?>
                Swal.fire('Sukses', 'Ukuran berhasil dihapus', 'success');
